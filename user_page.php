    ...
    <!-- =============== Navigation ================ -->
        ...
        <div class="main">
            ...
            <div class="content2">
                ...
                <p>This is the user page. Some access might not be available.</p>
            </div>
        ...
        <script>
            ...
            profileLink.addEventListener('click', () => {
                ...
                // Toggle the visibility state and the 'indent' class
                linksVisible = !linksVisible;
                adminProfileLi.classList.toggle('indent', linksVisible);
                adminPasswordLi.classList.toggle('indent', linksVisible);
            });
        </script>
