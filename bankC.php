        ...
        <div class="main">
            ...
            <div class="role-list">
                ...
                <?php
                    ...
                    if ($hasPostAccess) : ?>
                        <a href="addBankC.php" class="add-user-button">Add Product</a>
                <?php endif; ?>    
                ...
                <table>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($hasUpdateAccess) {
                            echo '<a href="edit_productC.php?product_id=' . $product_id . '" class="edit-button">Edit</a>';
                        }
                        echo '</td>';
                        echo '<td class="actions-cell">';
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                xhr.open('GET', `delete_productC.php?delete_product=${productId}`, true);
