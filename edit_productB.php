...
if (isset($_GET['product_id'])) {
    ...
    $select_query = "SELECT * FROM BankB WHERE product_id = ?";
...
if (isset($_POST['update_product'])) {
    ...
    $update_query = "UPDATE BankB SET product_name = '$updated_product_name', isActive = '$updated_is_active', Nominal = '$updated_nominal' WHERE product_id = '$product_id'";
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="add-user-button-container">
                <a href="bankB.php" class="add-user-button">Back</a>
            </div>
