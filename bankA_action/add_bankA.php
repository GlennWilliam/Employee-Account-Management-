...
if (isset($_POST['add_product'])) {
    ...
    $check_query = "SELECT COUNT(*) FROM BankA WHERE product_name = '$product_name'";
    ...
    if (!$result) {
        ...
        if ($existing_count > 0) {
            header("Location: bankA.php?message=Product with the same name already exists.");
            ...
            if (mysqli_affected_rows($conn) > 0) {
                ...
                header("Location: ../bank/bankA.php?message=Product added successfully");
                exit();
            } else {
