...
if (isset($_POST['add_product'])) {
    ...
    $insert_query = "INSERT INTO BankA (product_name, isActive, Nominal) VALUES ('$product_name', '$is_active', '$nominal')";
    mysqli_query($conn, $insert_query);

    if (mysqli_affected_rows($conn) > 0) {
        $success_message = "Product added successfully";
        header("Location: bankA.php?message=Product added successfully");
        exit();
    } else {
...
if (isset($_GET['product_id'])) {
    ...
    $select_query = "SELECT * FROM BankA WHERE product_id = ?";
...
if (isset($_POST['update_product'])) {
    ...
    $update_query = "UPDATE BankA SET product_name = '$updated_product_name', isActive = '$updated_is_active', Nominal = '$updated_nominal' WHERE product_id = '$product_id'";
    mysqli_query($conn, $update_query);

    if (mysqli_affected_rows($conn) > 0) {
        $success_message = "Product updated successfully";
        header('Location: ../bank/bankA.php');
    } else {
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="add-user-button-container">
                <a href="../bank/bankA.php" class="add-user-button">Back</a>
            </div>
