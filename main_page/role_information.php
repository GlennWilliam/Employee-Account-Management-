        ...
        <div class="main">
            ...
            if ($hasPostAccess) : ?>
                <div class="add-user-button-container">
                    <a href="../role_information_action/add_role.php" class="form2-btn">Add Role</a>
                </div>
            <?php endif; ?>
            ...
            <tbody>
                ...
                while ($row_role = mysqli_fetch_assoc($result_roles)) {
                    ...
                    echo '<td>';
                        if ($hasDetailsAccess) {
                            echo '<a class="button-link" href="../role_information_action/role_details.php?role_id=' . $role_id . '">Details</a>';
                        }
                    echo '</td>';

                    
                    if ($hasDeleteAccess) {
                        echo '<td><a class="button-link" href="../role_information_action/delete_role.php?role_id=' . $role_id . '" onclick="return confirm(\'Are you sure you want to delete this role?\')">Delete</a></td>';
                    }
                                        
                    if ($hasUpdateAccess) {
                        echo '<td><a class="button-link" href="../role_information_action/edit_role.php?role_id=' . $role_id . '">Edit</a></td>'; // Add the Update button
                    }
