        ...
        <div class="main">
            ...
            <div class="role-list">
                ...
                <?php
                    ...
                    if ($hasPostAccess) : ?>
                        <a href="addBankA.php" class="add-user-button">Add Product</a>
                <?php endif; ?>
                ...
                <table>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($hasUpdateAccess) {
                            echo '<a href="edit_product.php?product_id=' . $product_id . '" class="edit-button">Edit</a>';
                        }
                        echo '</td>';
                        echo '<td class="actions-cell">';
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                xhr.open('GET', `delete_product.php?delete_product=${productId}`, true);
