...
if (isset($_POST['add_user'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (mysqli_affected_rows($conn) > 0) {
            header('Location: employeeinformation.php?message=User added successfully'); // Redirect to refresh the user list
            exit();
        } else {
        ...
        <div class="main">
            ...
            <div class="add-user-form">
                ...
                <div class="add-user-button-container">
                    <a href="employeeinformation.php" class="form2-btn">Back</a>
                </div>
                <br>
