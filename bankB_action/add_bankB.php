...
if (isset($_POST['add_product'])) {
    ...
    $check_query = "SELECT COUNT(*) FROM BankB WHERE product_name = '$product_name'";
    ...
    if (!$result) {
        ...
        if ($existing_count > 0) {
            header("Location: ../bank/bankB.php?message=Product with the same name already exists.");
            $error_message = "Product with the same name already exists.";
        } else {
            // Insert the new product if it doesn't already exist
            $insert_query = "INSERT INTO BankB (product_name, isActive, Nominal) VALUES ('$product_name', '$is_active', '$nominal')";
            mysqli_query($conn, $insert_query);

            if (mysqli_affected_rows($conn) > 0) {
                $success_message = "Product added successfully";
                header("Location: ../bank/bankB.php?message=Product added successfully");
                exit();
            } else {
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="add-user-button-container">
                <a href="../bank/bankB.php" class="add-user-button">Back</a>
            </div>
