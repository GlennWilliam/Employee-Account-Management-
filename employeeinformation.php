...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <?php
                $hasUpdateAccess = checkUserAccessUpdate($conn, $userId, 'Employee Information'); // Replace $userId with actual user ID
        ...
        <div class="user-list">
            ...
            if ($hasPostAccess) : ?>
                <div class="add-user-button-container">
                    <a href="add_user.php" class="form2-btn">Add User</a>
                </div>
            <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <?php foreach ($accessibleActions as $actionLabel => $hasAccess) : ?>
                                <td>
                                    ...
                                    <?php else : ?>
                                        <a href="user_details.php?user_id=<?php echo $row['user_id']; ?>" class="details-btn"><?php echo $actionLabel; ?></a>
                                    <?php endif; ?>
                                </td>
                            <?php endforeach; ?>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    const newUrl = `edit_user.php?user_id=${userId}`;
