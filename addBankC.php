...
if (isset($_POST['add_product'])) {
    ...
    if (!$result) {
        ...
        if ($existing_count > 0) {
            header("Location: bankC.php?message=Product with the same name already exists.");
            ...
            if (mysqli_affected_rows($conn) > 0) {
                ...
                header("Location: bankC.php?message=Product added successfully");
                exit();
            } else {
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="add-user-button-container">
                <a href="bankC.php" class="add-user-button">Back</a>
            </div>
