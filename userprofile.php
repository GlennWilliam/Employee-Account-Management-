...
if (isset($_POST['change_password'])) {
    ...
    if ($new_password !== $confirm_new_password) {
        ...
        $select = "SELECT * FROM user_information WHERE user_id = '$user_id' AND password = '$old_password'";
        $result = mysqli_query($conn, $select);

        if (mysqli_num_rows($result) > 0) {
            $update = "UPDATE user_information SET password = '$new_password' WHERE user_id = '$user_id'";
        ...
        <div class="main2">
            <div class="content">
                ...
                <table>
                    ...
                    <tr>
                        <td>Last Name:</td>
                        <td><?php echo $_SESSION['user_name2'] ?></td>
                    </tr>
                    <tr>
                        <td>Email:</td>
