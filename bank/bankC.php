...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="role-list">
                <h3>Bank C Information</h3>
                <?php
                    $select_query = "SELECT * FROM BankC";
                    $result = mysqli_query($conn, $select_query);
                    $userId = $_SESSION['user_id'];


                    $hasPostAccess = checkUserAccessPost($conn, $userId, 'Bank C');
                    if ($hasPostAccess) : ?>
                        <a href="../bankC_action/add_bankC.php" class="add-user-button">Add Product</a>
                <?php endif; ?>    
                ...
                <table>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($hasUpdateAccess) {
                            echo '<a href="../bankC_action/edit_bankC.php?product_id=' . $product_id . '" class="edit-button">Edit</a>';
                        }
                        echo '</td>';
                        echo '<td class="actions-cell">';
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                xhr.open('GET', `../bankC_action/delete_bankC.php?delete_product=${productId}`, true);
